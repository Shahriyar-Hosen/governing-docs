    ...
    <section className="pt-10 md:pt-20 xl:pt-28">
      <Container className="flex gap-5 md:gap-0 justify-center md:justify-end items-center flex-col-reverse md:flex-row">
        <div className="space-y-[29px]">
          <h1 className="font-space-grotesk font-bold text-3xl md:text-4xl lg:text-6xl leading-[45px] md:leading-[60px] lg:leading-[76.56px] text-secondary capitalize max-w-[593px]">
